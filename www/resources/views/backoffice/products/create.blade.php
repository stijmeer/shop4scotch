...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($product, ['route' => ['backoffice.products.store'], 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {{--general information--}}
                        <fieldset>
                            <legend id="legend">New Product's Name</legend>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group col-md-12" id="imgProductGroup">
                                {!! Form::label($name = 'img_product', $value = 'Product Image', $options = [
                                    'class' => 'control-label',
                                ]) !!}
                                {!! Form::file($name = 'img_product', $value = null, $options = [
                            ...
                            <div class="form-group col-md-6 hidden" id="imgPackagingGroup">
                                {!! Form::label($name = 'img_packaging', $value = 'Packaging Image', $options = [
                                    'class' => 'control-label',
                                ]) !!}
                                {!! Form::file($name = 'img_packaging', $value = null, $options = [
                                    'class' => 'btn btn-secondary btn-lg btn-block',
                                    'id' => 'img_packaging',
                                ]) !!}
                            </div>
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        inputfield.onkeyup = function () {
            document.getElementById('legend').innerHTML = "New Product: " + inputfield.value;
        };
        ...
        // Show package file input only when a form of packaging is selected
        $('#packaging').change(function () {
            if ($('#packaging').val() == 0) {
                // add "col-md-12" class and remove "col-md-6" class if present
                if (!$('#imgProductGroup').hasClass('col-md-12')) {
                    $('#imgProductGroup').addClass('col-md-12');
                    $('#imgProductGroup').removeClass('col-md-6');
                }
                // Add "hidden" class
                if (!$('#imgPackagingGroup').hasClass('hidden')) {
                    $('#imgPackagingGroup').addClass('hidden');
                }
                // Remove package image
                $('#img_packaging').val('');
                $('#imgPackagingGroup .input-group input').val('');
            } else {
                // add "col-md-6" class and remove "col-md-12" class if present
                if (!$('#imgProductGroup').hasClass('col-md-6')) {
                    $('#imgProductGroup').addClass('col-md-6');
                    $('#imgProductGroup').removeClass('col-md-12');
                }
                // Remove "hidden" class
                if ($('#imgPackagingGroup').hasClass('hidden')) {
                    $('#imgPackagingGroup').removeClass('hidden');
                }
            }
        });
